  ...
  return (
    <section className={styles.about__section}>
      <div className="container">
        <div>
          <p className={`text text__big--1 ${visible ? 'animate__animated animate__fadeIn' : ''}`} ref={aboutRef}>Desenvolvedor web apaixonado pelo estudo em lógica de programação, iniciei meus estudos em C++ no fim do ano de 2021,
          ...
          <p className={`text text__big--1 ${visible ? 'animate__animated animate__fadeIn' : ''}`}>Em 2024, iniciei meus estudos na Kenzie Academy Brasil, onde aprendi diversas tecnologias e soft skills. Também tive a
        ...
        <button type="button" className={visible ? 'animate__animated animate__fadeInUp' : ''}><a href="" download className='text text__big--2'>Baixar currículo</a></button>
      </div>
